...
export default function Footer() {
    ...
    return (
        /* Adicionada a classe 'hidden md:block' para remover do mobile completamente */
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
                    ...
                    <div className="md:col-span-3">
                        <div className="p-6 rounded-[32px] bg-card-custom border border-border-custom shadow-xl shadow-black/5 space-y-4 transition-transform hover:scale-[1.02]">
                ...
                {/* Bottom Bar */}
                <div className="pt-10 border-t border-border-custom flex flex-row justify-between items-center gap-6">
